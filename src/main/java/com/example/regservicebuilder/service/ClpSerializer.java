...
import com.example.regservicebuilder.model.DistrictClp;
import com.example.regservicebuilder.model.FarmerClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "myregister-1.0-SNAPSHOT-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "myregister-1.0-SNAPSHOT";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "com.example.regservicebuilder.model.impl.DistrictImpl")) {
        ...
        if (oldModelClassName.equals(
                    "com.example.regservicebuilder.model.impl.FarmerImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals(
                    "com.example.regservicebuilder.NoSuchDistrictException")) {
            return new com.example.regservicebuilder.NoSuchDistrictException();
        }

        if (className.equals(
                    "com.example.regservicebuilder.NoSuchFarmerException")) {
            return new com.example.regservicebuilder.NoSuchFarmerException();
        }
